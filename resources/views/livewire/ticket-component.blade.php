                ...
                <div class="intro-y col-span-12 md:col-span-6 lg:col-span-4 xl:col-span-3">
                    <div class="box">
                        ...
                        <div class="flex justify-center lg:justify-end items-center p-5 border-t border-slate-200/60 dark:border-darkmode-400">
                            ...
                            {{-- <a class="flex items-center text-danger" href="#" wire:click.prevent="downloadQRCode({{ $ticket->id }})"> <i data-lucide="download" class="w-4 h-4 mr-1"></i> Download </a> --}}
        ...
        <!-- QR code preview modal -->
            ...
            <div class="fixed top-0 left-0 w-full h-full flex items-center justify-center bg-gray-800 bg-opacity-50" style="z-index: 9999;">
                <div class="bg-white w-96 mx-auto rounded-lg p-5">
                    <h2 class="text-lg font-bold mb-4">QR Code Pre {{$ticket->id}}</h2>
