...
<div class="intro-y box py-10 sm:py-20 mt-5">
    ...
    <div class="px-5 sm:px-20 mt-10 pt-10 border-t border-slate-200/60 dark:border-darkmode-400">
        <div class="font-medium text-base">Profile Contact</div>
        <form action="{{ route('kycProfileFour') }}" method="post">
            @csrf
            <input type="hidden" name="user_id" value="{{ $user_id }}">

            <div class="grid grid-cols-12 gap-4 gap-y-5 mt-5">
                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-1" class="form-label">residential_address</label>
                    <input id="input-wizard-1" type="text" class="form-control" placeholder="Goma" name="residential_address">
                </div>
                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-2" class="form-label">mailing_address</label>
                    <input id="input-wizard-2" type="text" class="form-control" placeholder="mailing_address" name="mailing_address">
                </div>
                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-3" class="form-label">email address</label>
                    <input id="input-wizard-3" type="text" class="form-control" placeholder="banks@sanaa.co" name="email_address">
                </div>
                <div class="intro-y col-span-12 sm:col-span-6">
                ...
                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label">emergency contact relationship</label>
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="emergency_contact_relationship" name="emergency_contact_relationship">
                </div>

                <div class="intro-y col-span-12 sm:col-span-6">
                    <label for="input-wizard-4" class="form-label">emergency contact Phone</label>
                    <input id="input-wizard-4" type="text" class="form-control" placeholder="07007000700" name="emergency_contact_phone">
                </div>
